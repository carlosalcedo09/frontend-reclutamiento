...
import { Send, Heart, House, Building, Gpu, Clock2, ClockFading,MailWarning, BadgeCheck, HatGlasses, MailCheck, TriangleAlert } from "lucide-react";
import api from '@/lib/axios';


export default function JobCard({ ofert, isLoggedIn, setModalConfirmContent, setIsModalConfirmOpen, onOpenModal }) {
  return (
    <div
    ...
    >
      <div className="flex justify-between items-center gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <div
            className="bg-gray-100 w-10 h-10 flex items-center justify-center rounded-full hover:bg-gray-200 transition"
            onClick={(e) => { e.stopPropagation(); console.log("Me gusta acción para:", ofert.id); }}
          >
      ...
      <div className="flex items-center gap-2">
        {ofert.employment_type === "Full-Time" && <Clock2 className="w-4 h-4 text-gray-500" />}
        {ofert.employment_type === "Part-Time" && <ClockFading className="w-4 h-4 text-gray-500" />}
